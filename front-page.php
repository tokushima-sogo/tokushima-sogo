        ...
        <section id="js_1f" class="u-bgEAE4AD u-mb4p">
            <div class="p-floorBlock_info">
                ...
                <div class="p-guideArea u-m0A">
                    ...
                    <p class="u-mb10">当サイトは“架空の案内所“をモチーフにし、徳島県の観光情報を掲載したサイトです。
                        実際に案内所に訪れた時のように、一階から最上階までゆっくり楽しんでみてください！
                    </p>
                    <p>行きたい場所を見つけたら、<span>「MYマップに追加」</span>ボタンを押す事で、MYマップに登録できます。<br>
                        サイト上部の<span>「MYマップ」</span>ボタンを押せば自分だけの地図が完成です！</p>
                </div>
            </div>
        </section>
