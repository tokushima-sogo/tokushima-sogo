...
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/aboutsite.css" rel="stylesheet">
<link href="<?php echo get_template_directory_uri(); ?>assets/css/abouttokushima.css" rel="stylesheet">
...
<main class="p-conceptBase__main">
    <section id="p-aboutsite__main">
        <div class="p-conceptBase__heading u-bgIndigo">
            <h2 class="p-conceptBase__heading__title u-white">徳島について</h2>
        </div>
        <div class="c-aboutBox__item u-bgWhite">
            <p class="c-aboutBox__abt__font.u-m40 ">
